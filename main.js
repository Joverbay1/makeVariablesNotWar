...
let myFirstName = 'Jen';
let myLastName = 'Overbay';
let myBestFriend = 'Kylee';
let mySentence = 'my name is ' + myFirstName + ' ' + myLastName + ' and this is my best friends name' + myBestFriend;
let myFavoriteNum = 13;
let myHeight = 68;
let myFavoriteYear = 2001;
